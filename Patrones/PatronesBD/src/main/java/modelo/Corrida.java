...
public class Corrida {
    ...
    public String toString() {
        return "Corrida{" + "idCorrida=" + idCorrida + ", origen=" + origen + ", destino=" + destino + ", fechaSalida=" + fechaSalida + ", horaSalida=" + horaSalida + ", fechaLlegada=" + fechaLlegada + ", horaLlegada=" + horaLlegada + ", escalas=" + escalas + '}';
    }
